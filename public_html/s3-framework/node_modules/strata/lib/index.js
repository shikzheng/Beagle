...
/**
 * Creates a valid Strata application from the given `obj` and performs some
 * quick sanity checks to make sure the app is valid.
 */
function makeApp(obj) {
    // May be any object that has a toApp method (e.g. a Builder).
    if (typeof obj.toApp == "function") {
        obj = obj.toApp();
    }
    ...
    if (obj.length != 2) {
        throw new StrataError("App must accept two arguments");
    }
